...
To check if there is an attached volume, log on (ssh) onto your EC2 instance (Original recipe located [here](http://maplpro.blogspot.com/2012/05/how-to-mount-ebs-volume-into-ec2-ubuntu.html). 
