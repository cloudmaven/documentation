...
keywords: research_computing, genomics
last_updated: October 6, 2016
tags: [research_computing, genomics, spark, case_studies, AWS, Azure, organic_chemistry, data_science, scale]
summary: "Parallel Epigenomics Data Imputation with Cloud-based Tensor Decomposition"
...
## Introduction
The purpose of this page is to describe a methodology study in genomics to impute (computationally
infer) information connecting cell types, proteins and the human genome. The study is currently in
preparation as a research paper. The work is performed on the public cloud, both AWS and Azure platforms.
