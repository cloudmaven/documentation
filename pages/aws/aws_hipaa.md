...
- *K* contacts IT professional *J* for the SCE as a working environment
  - Some initial steps align *K* and *J* to build an SCE
  - The SCE is set up by *J* with *K* helping as described below
  - Data are uploaded to S3 storage on AWS from a secure device
...
## Appendix A Fossil residual please refactor back into the above
