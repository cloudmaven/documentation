...
at my disposalâ€¦ to a resource that I want to share for example.  This ip stuff is distinct from a DNS entry. The latter is a person
...
You can "upgrade" a Snapshot to an AMI in Linuxâ€¦ but it is more complicated for Windows. And this is a little bit vague: Do 
